...
/**
 * Constructor con parametros de la clase CelulaSuicida, el atributo sera definido manualmente en los parametro
 * @param contador valor de pasos hasta la explosión
 */
	public CelulaSuicida(int contador){
 ...
 */
	...
	public Celula cargar(String[] datos) throws ErrorFormatoNumerico {
		Celula celula = null;
		if(datos[2].equalsIgnoreCase("suicida") && datos.length== 4){
			try{
				int CT = Integer.parseInt(datos[3]);
				celula = new CelulaSuicida(CT);
