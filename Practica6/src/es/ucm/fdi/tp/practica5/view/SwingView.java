...
*/
	 ...
	 * <p> Procedimiento de maquetaci�n del frame principal</p> 
	 */
...
//----------------------------------PANEL DE CONTROLADOR------------------------------------//
	 ...
	 * <p> Procedimiento de creaci�n del panel aglomerador de componentes</p> 
	 */
	 ...
	 * <b>gameMessagesPanel</b>
	 * <p> Creation procedure accumulator panel components</p>
	 * <p> Procedimiento de creaci�n de un panel etiquetado y centrado</p> 
...
//----------------------------------COMPONENTE DE TEXTO------------------------------------//
	 ...
	 * <p> Procedimiento de creaci�n del componente de mensajes de estado del juego</p> 
	 */
...
//-------------------------COMPONENTE DE INFORMACION DE JUGADORES--------------------------//	
	 ...
	 * <p>Panel contenedor del tablon de informaci�n de jugadores </p>
	 */
	 ...
	 * <p> Procedimiento de creaci�n del componente de informacion de jugadores</p> 
	 */
...
//-------------------------COMPONENTE DE CAMBIO DE COLORES-------------------------------//	
	 ...
	 * <p> Procedimiento de creaci�n del componente de cambio de colores</p> 
	 */
...
//-------------------------COMPONENTE DE CAMBIO DE MODOS-------------------------------//	
	 ...
	 * <p> Procedimiento de creaci�n del componente de cambio de modos</p> 
	 */
	@SuppressWarnings("serial")
...
//--------------------------COMPONENTE DE MOVIMIENTO AUTOMATICO-------------------------------//	
	 ...
	 * <p> Procedimiento de creaci�n del componente de movimientos automaticos</p> 
	 */
